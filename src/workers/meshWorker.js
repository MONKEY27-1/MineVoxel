...
self.onmessage = (event) => {
  ...
  if (msg.type === 'mesh') {
    const { jobId, cx, cz, sy, blocks, skyLight, blockLight, borders, skyLightBorders, blockLightBorders, aoStrength } = msg;
    const { opaque, transparent } = greedyMeshSection(blocks, skyLight, blockLight, borders, skyLightBorders, blockLightBorders, atlasUV, aoStrength);
